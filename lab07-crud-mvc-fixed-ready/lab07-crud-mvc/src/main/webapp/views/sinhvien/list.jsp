...
<div class="container">
    ...
    <div class="card">
        ...
        <form method="get"
            ...
            <a href="${pageContext.request.contextPath}/sinhvien?action=form"
                                ...
                                <td>
                                    ...
                                    <div class="actions">
                                        ...
                                        <a class="btn btn-primary"
                                           href="${pageContext.request.contextPath}/sinhvien?action=detail&id=${sinhVien.id}">
                                            Xem
                                        </a>
                                        ...
                                        <a class="btn btn-danger"
                                           href="${pageContext.request.contextPath}/sinhvien?action=delete&id=${sinhVien.id}"
